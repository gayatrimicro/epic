...
<section class="page-builder-block hero" data-single-hero="true" data-alignment="left">
  <div class="container">
    <div class="cols hero__wrapper">
        ...
        <h1 data-break="lines">Injured Patients</h1>

        <p class="p1">Get your Workers' Compensation medications DELIVERED at NO COST to YOU.</p>
        ...
        <!-- <p class="p1"><span style="font-weight: 400;">The pharmacists at Epic Pharmacy are uniquely trained to supervise the prescribed drug therapies for cancer patients. They will also work closely with you to help maximize the benefits of your prescription medication regimen.
        </span>
        </p> -->
...
<section class="page-builder-block text-image-cols js-block" data-block="text-image-cols-block" data-reversed="true" data-sticky="false" data-spacing="medium">
            ...
            <div class="text-image-cols__image-wrapper">
              <div class="text-image-cols__image-inner">
                ...
                <div class="text-image-cols__image">
                  <figure class='text-image-cols__fig cover cover--all cover--crop-center'><img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/ip-banner.jpg' data-srcset='../assets/images/ip-banner.jpg 620w, ../assets/images/ip-banner.jpg 1240w, ' alt='Workers Compensation' width='800' height='800'  data-pin-nopin='true' data-object-fit />                  </figure>
                </div>
  ...
  <div class="general-content">
        ...
        <p>When you are hurt on-the-job, you need fast access to your medications, with no hassles or hoops to jump through.


        At Epic Pharmacy, we understand the needs of injured workers. From prompt fills for pain relieving medications to dedicated account representatives for a single point of contact, we offer one-stop express care for injured workers.
               ...
               <div class="listing-blocks__wrapper">
                  <div class="cols">
                        ...
                        <div class="listing-blocks__fig-wrapper">
                           <div class="listing-blocks__fig-inner">
                              <figure class="listing-blocks__fig cover cover--all">
                                 <img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/ip-proud.jpg' data-srcset='../assets/images/ip-proud.jpg 750w, ../assets/images/ip-proud.jpg 1200w, ' alt='Epic Pharmacy proudly offers' width='800' height='800'  data-pin-nopin='true' data-object-fit />              
                              </figure>
                           </div>
                        </div>
                     </div>
                     <div class="listing-blocks__inner col m12 tp8 t6 d4">
                        ...
                        <h3 class="listing-blocks__heading"> Epic Pharmacy proudly offers:</h3>
                        <div class="listing-blocks__content">
                           <p>
                           <ul>
                              <li>Rapid turnaround times</li>

                              <li>Access to medications at no cost to you</li>

                              <li>Fast local pickup or speedy doorstep delivery</li>

                              <li>Comprehensive medication management</li>

                              <li>No need to wait for a case number to be assigned</li>

                              <li>Simple, rapid refills</li>
                           </ul>
                           </p>
                        </div>
                     </div>
            ...
            <li class="listing-blocks__item col m12" data-layout="col" data-anim="false">
               <div class="listing-blocks__wrapper">
                  <div class="cols">
                     ...
                     <div class="listing-blocks__inner col m12 tp8 t6 d4">
                        <h4 class="listing-blocks__subheading"></h4>
                        <h3 class="listing-blocks__heading">Personal Injury &amp; Letter of Protection</h3>
                        <div class="listing-blocks__content">
                           <p>For those patients suffering from a personal injury such as a car accident,  Epic Pharmacy is committed to simplifying the process and providing peace of mind so you can focus on what’s most important – getting better and returning to a productive life. With convenient locations providing free delivery nationwide, we proudly offer no out-of-pocket expense for prescription medications to those patients suffering from a personal injury.
                           </p>
                        </div>
                     </div>
                     <div class="listing-blocks__fig-container col m12 t6 d4">
                        <div class="listing-blocks__fig-wrapper">
                           <div class="listing-blocks__fig-inner">
                              <figure class="listing-blocks__fig cover cover--all">
                                 <img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/ip-lop.jpg' data-srcset='../assets/images/ip-lop.jpg 750w, ../assets/images/ip-lop.jpg 1200w, ' alt='Letter of Protection' width='800' height='800'  data-pin-nopin='true' data-object-fit />            
                              </figure>
                           </div>
                  ...
                  <div class="cols">
                     <div class="listing-blocks__fig-container col m12 t6 d4">
                        <div class="listing-blocks__fig-wrapper">
                           <div class="listing-blocks__fig-inner">
                              <figure class="listing-blocks__fig cover cover--all">
                                 <img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/ip-attorney.jpg' data-srcset='../assets/images/ip-attorney.jpg 750w, ../assets/images/ip-attorney.jpg 1200w, ' alt='Experienced Attorney' width='800' height='800'  data-pin-nopin='true' data-object-fit />              
                              </figure>
                           </div>
                        </div>
                     </div>
                     <div class="listing-blocks__inner col m12 tp8 t6 d4">
                        <h4 class="listing-blocks__subheading"></h4>
                        <h3 class="listing-blocks__heading">Experienced Attorney</h3>
                        <div class="listing-blocks__content">
                           <p>As part of our commitment to simplifying the lives of our patients,  Epic Pharmacy pledges to work seamlessly and collaboratively with providers and attorneys to make this process as easy and cost effective as possible for all parties involved. This includes offering providers with a Personalized Account Representative (a single point of contact for the pharmacy), a 24-hour turnaround on filling prescriptions, as well as a steadfast commitment to patients to ensure proper medication management.</p>
