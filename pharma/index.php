...
<meta name="google-site-verification" content="A-llZMVa8hZh-UpSwLh1pVOmWUxxhd8MrBf7OTQjtEE" />
  ...
  <title>Oklahoma Pharmacy Partnerships | Epic Pharmacy</title>

  <meta name="description" content="Healthcare & hospital prescription rx online. Call Us at 405-724-7852 to refill your prescription." >

  <meta name="keywords" content="partnership oklahoma pharmacy, pharmacy store business, how to open a pharmacy business, pharmacy franchisee owner">
...
<section class="page-builder-block text-image-cols js-block" data-block="text-image-cols-block" data-reversed="true" data-sticky="false" data-spacing="medium">
  <h1 style="text-align: center;margin-bottom: 70px;">Pharma</h1>
  <div class="container">
            ...
            <div class="text-image-cols__image-wrapper">
              <div class="text-image-cols__image-inner">
                ...
                <div class="text-image-cols__image">
                  <figure class='text-image-cols__fig cover cover--all cover--crop-center'><img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/pharma-1.jpg' data-srcset='../assets/images/pharma-1.jpg 620w, ../assets/images/pharma-1.jpg 1240w, ' alt='asthma-1' width='800' height='800'  data-pin-nopin='true' data-object-fit />                  </figure>
                </div>
  ...
  <div class="general-content">
        ...
        <p>Would you like to strengthen your local position using successful sales promotion measures? Do you plan to expand into new markets? If so, you need a strong partner who understands the local market dynamics.</p>

        <p>Whatever your aims may be, we want to create all-round added value for you by enhancing your product portfolio. Epic Pharmacy opens up your market potential based on strong local brands.</p>


        <p>Epic Pharmacy makes it possible for you, our industry partners, to secure even faster, simpler and more standardised access to American and local markets. We offer direct access to patients through the pharmacy members. Your access to success has never been so direct and close.
        </p>
  ...
  <div class="listing-blocks__wrapper">
    <div class="cols">
      <div class="listing-blocks__fig-container col m12 t6 d4">
        <div class="listing-blocks__fig-wrapper">
              ...
              <figure class="listing-blocks__fig cover cover--all">
                <<img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/pharma-2.jpg' data-srcset='../assets/images/pharma-2.jpg 620w, ../assets/images/pharma-2.jpg 1240w, ' alt='asthma-1' width='800' height='800'  data-pin-nopin='true' data-object-fit />            </figure>
            </div>
                  </div>
      </div>
      ...
      <div class="listing-blocks__inner col m12 tp8 t6 d4">
        ...
        <h3 class="listing-blocks__heading pad-bot">Our focus areas for your success</h3>
        ...
        <div class="listing-blocks__content">
                      ...
                      <ol style="margin-top: 0px;">
                        <li>Commercial Partnerships – Grow your sales.</li>
                        <li>Healthcare Logistics – International pharma logistics network</li>
                        <li>Business Intelligence – Patient behaviour insights for better business decisions</li>
                        <li>Clinical Trial Supply Services – Full-service around your clinical trials</li>
                        <li>Patient Services – Optimise the patient experience with awareness and adherence programs</li>
                        <li>Sales Support – Representation and market access</li>
                        <li>Specialty – Special handling and special pharma logistics</li>
                        <li>Supply Chain Optimisation – Increase the effectiveness of your supply chain</li>
