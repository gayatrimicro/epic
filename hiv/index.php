...
<section class="page-builder-block hero" data-single-hero="true" data-alignment="left">
  <div class="container">
    <div class="cols hero__wrapper">
        ...
        <h1 data-break="lines">HIV / AIDS</h1>
...
<section class="page-builder-block text-image-cols js-block" data-block="text-image-cols-block" data-reversed="true" data-sticky="false" data-spacing="medium">
  ...
  <div class="general-content">
        ...
        <p>HIV attacks the CD4 cells, a subtype of T-cells responsible for fighting infections in the body. This, in turn, takes away the body's capability to defend itself against infections.</p>
               ...
               <div class="listing-blocks__wrapper">
                  <div class="cols">
                     ...
                     <div class="listing-blocks__inner col m12 tp8 t6 d4">
                        ...
                        <h3 class="listing-blocks__heading  pad-bot">Early Stage HIV Symptoms:</h3>
                  ...
                  <div class="cols">
                     ...
                     <div class="listing-blocks__inner col m12 tp8 t6 d4">
                        ...
                        <div class="listing-blocks__content">
                          ...
                          <br>Unprotected sex puts you at risk of other sexually transmitted infections. This applies to both men and women.
                           </p>
                        </div>
                     </div>
                     <div class="listing-blocks__fig-container col m12 t6 d4">
            ...
            <li class="listing-blocks__item col m12" data-layout="col" data-anim="false">
               <div class="listing-blocks__wrapper">
                  <div class="cols">
                     ...
                     <div class="listing-blocks__inner col m12 tp8 t6 d4">
                        <h4 class="listing-blocks__subheading"></h4>
                        <h3 class="listing-blocks__heading pad-bot">MEET FOR PEP TREATMENT</h3>
                        <div class="listing-blocks__content">
                           <p>PEP is the abbreviation for Post-exposure prophylaxis. It is the course of HIV medication that is prescribed to the person infected with this deadly virus. The medications are given soon after the person gets the infection. PEP medicines prevent the virus from damaging the immune system.</p>
                           <p>The treatment must be started within 72 hours of exposure to HIV infection. If given late, the medicines do not provide desired effects.</p>
