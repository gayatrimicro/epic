...
<section class="page-builder-block hero js-block" data-block="text-image-cols-block" data-sticky="false" data-reversed="true">
  <div class="container">
    <div class="cols hero__wrapper">
          ...
          <div class="hero__image-container">
              ...
              <div class="hero__image-inner">
                <figure class="hero__fig cover cover--all">
                  <img class='' src='../assets/images/jot-banner.jpg' srcset='../assets/images/jot-banner.jpg 750w, ../assets/images/jot-banner.jpg 1600w, ' alt='Company culture' width='800' height='800'  data-pin-nopin='true' />                </figure>
              </div>
            </div>
          </div>
        </div>
        ...
        <h1 data-break="lines">The Epic pharmacy Family</h1>

        <p class="p1">Our advanced team of professionals at Epic pharmacy views
                      ...
                      above and beyond in all we do.</p>
...
<section class="page-builder-block text-image-cols js-block" data-block="text-image-cols-block" data-reversed="false" data-sticky="false" data-spacing="medium">
  <div class="container">
    <div class="cols text-image-cols__wrapper">
            ...
            <div class="text-image-cols__image-wrapper">
              <div class="text-image-cols__image-inner">
                ...
                <div class="text-image-cols__image">
                  <figure class='text-image-cols__fig cover cover--all cover--crop-center'><img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/jot-family.jpg' data-srcset='../assets/images/jot-family.jpg 620w, ../assets/images/jot-family.jpg 1240w, ' width='800' height='800'  alt='Company culture' data-pin-nopin='true' />                  </figure>
                </div>
      ...
      <div class="col m12 tp8 t5 d5 c4 hero__text-wrapper js-text-wrapper" data-anim="false">
        ...
        <h1 data-break="lines">The Face of <br>Epic pharmacy</h1>

        <p class="p1">We're a highly-diversified team of professionals who come from all walks of life, family backgrounds and belief systems (just like our patients). While we don't all look the same, at the heart of each one of us is a smile.</p>
  ...
  <form id="" name="" class="form">
     ...
     <textarea cols="10" id="text_area" rows="10" name="text_area" placeholder="Write Your Messages.." class="form-control" required></textarea>
      ...
      <div class="form-group">
      <button id="" type="submit" class="btn btn-default submit">Submit</button>
      </div>
