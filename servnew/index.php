...
<section class="SecExp">
  <div class="container">
    ...
    <div class="row_col">
      ...
      <div class="col_8">
        <p>Our reimbursement specialists handle coordination of benefits and are attentive to real life issues and the cost of PrEP. We gladly assist in prior authorization approval and accept the majority of insurance plans. Because cost could be a concern for some patients, our team is your advocate. We work diligently to find other financial assistance if needed.</p>
      </div>
    </div>
    <hr>
    <div class="row_col">
