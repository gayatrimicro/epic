...
<meta name="google-site-verification" content="A-llZMVa8hZh-UpSwLh1pVOmWUxxhd8MrBf7OTQjtEE" />
  ...
  <title>Opthalmology Drugs | Epic Pharmacy</title>

  <meta name="description" content="Order Opthalmic Preparations & anti-infectives online. Call 888-688-0054 toll-free." >

  <meta name="keywords" content="Acthar, Bevacizumab, Cefazolin online order from pharmacy near me, treatment for opthalmic diseases, sterile eye drops, customized injectables for opthalmic treatment, alcaine, pontocaine drops">
  ...
  <meta property="og:url" content="https://epicpharmacyokc.com/specialties/ophthalmology/">
  ...
  <meta name="twitter:url" content="https://epicpharmacyokc.com/specialties/ophthalmology/">

  <meta name="robots" content="index, follow" />

  <link rel="canonical" href="https://epicpharmacyokc.com/specialties/ophthalmology/">
  <link rel="alternate" href="https://epicpharmacyokc.com/specialties/ophthalmology/" hreflang="en-us" />
...
<section class="page-builder-block hero" data-single-hero="true" data-alignment="left">
  <div class="container">
    <div class="cols hero__wrapper">
        ...
        <h1 data-break="lines">Ophthalmology Specialty Medications</h1>

        <p class="p1">Epic Pharmacy stocks a wide range of specialty, commercially available, compounded and supportive-care ophthalmology medications, including recently approved FDA-medications and those with limited distribution. </p>


        <p>Our flexible process means you can order exactly what your patient needs – customizing the drug, strength, dosage form and size. Whether you need ophthalmology pharmacy consultation services, fortified antibiotics, preservative-free topicals, surgery packs or combo drops, Epic Pharmacy offers a single solution for all your specialty and compounded medication needs.
        </p>
        ...
        <!-- <p class="p1"><span style="font-weight: 400;">
         The pharmacists at Epic Pharmacy are uniquely trained to supervise the prescribed drug therapies for cancer patients. They will also work closely with you to help maximize the benefits of your prescription medication regimen.
        </span>
        </p> -->
    ...
    <div class="cols">
      <div class="listing-blocks__fig-container col m12 t6 d4">
        <div class="listing-blocks__fig-wrapper">
              ...
              <figure class="listing-blocks__fig cover cover--all">
                <img class='lazyload' data-sizes='auto' data-lowsrc='../../assets/images/ophthalmology-2.jpg' data-srcset='../../assets/images/ophthalmology-2.jpg 750w, ../../assets/images/ophthalmology-2.jpg 1200w' alt='Insurance &amp; Billing' width='600' height='600'  data-pin-nopin='true' data-object-fit />              </figure>
            </div>
                  </div>
      </div>
      ...
      <div class="listing-blocks__inner col m12 tp8 t6 d4">
        ...
        <div class="listing-blocks__content">
                      ...
                      <p><strong>We compound medications that help you manage and eliminate several conditions like:</strong></p>
                      ...
                      <ol>
                        ...
                        <li>Fungal/Bacterial Eye Infections</li>
                        <li>Glaucoma</li>
  ...
  <div class="listing-blocks__wrapper">
    <div class="cols">
      ...
      <div class="listing-blocks__inner col m12 tp8 t6 d4">
        ...
        <h3 class="listing-blocks__heading pad-bot">Ophthalmology Compounding: Not Everyone is Qualified</h3>

        <div class="listing-blocks__content">
                      <p>provide custom medication solutions for various conditions of the body. However, ophthalmology compounding is less common, because specialized equipment and extreme sterile environments are mandated for the preparation of your eye medications. As a result, there are far fewer ophthalmology compounding pharmacies than for other types of medicines.</p>

                      <p>Epic Pharmacy is an experienced ophthalmology compounding pharmacy dedicated to absolute quality and uncompromising sterile preparation.
                      </p>
      ...
      <div class="listing-blocks__fig-container col m12 t6 d4">
        <div class="listing-blocks__fig-wrapper">
                                <div class="listing-blocks__fig-inner">
              <figure class="listing-blocks__fig cover cover--all">
                <img class='lazyload' data-sizes='auto' data-lowsrc='../../assets/images/ophthalmology-1.jpg' data-srcset='../../assets/images/ophthalmology-1.jpg 750w, ../../assets/images/ophthalmology-1.jpg 1200w' alt='Insurance &amp; Billing' width='600' height='600'  data-pin-nopin='true' data-object-fit />              </figure>
            </div>
                  </div>
      </div>
    ...
    <div class="cols">
      <div class="listing-blocks__fig-container col m12 t6 d4">
        <div class="listing-blocks__fig-wrapper">
                                <div class="listing-blocks__fig-inner">
              <figure class="listing-blocks__fig cover cover--all">
                <img class='lazyload' data-sizes='auto' data-lowsrc='../../assets/images/ophthalmology-3.jpg' data-srcset='../../assets/images/ophthalmology-3.jpg 750w, ../../assets/images/ophthalmology-3.jpg 1200w' alt='Insurance &amp; Billing' width='600' height='600'  data-pin-nopin='true' data-object-fit />              </figure>
            </div>
                  </div>
      </div>
      ...
      <div class="listing-blocks__inner col m12 tp8 t6 d4">
        ...
        <div class="listing-blocks__content">
                      ...
                      <p> In our certified, sterile clean room we will prepare your medications in the correct dosage, concentration and format, including:</p>

                      <ol>
                        <li>Drops</li>
                        <li>Injections</li>
                        <li>Intravenous (IV) Solutions</li>
                        <li>Ointments/Salves</li>
                        <li>Oral Tablets, Capsules or Liquids</li>
                      </ol>
                  </div>
