...
<meta name="google-site-verification" content="A-llZMVa8hZh-UpSwLh1pVOmWUxxhd8MrBf7OTQjtEE" />
  ...
  <meta property="og:url" content="http://epicpharmacyokc.com/services/">
  ...
  <meta name="twitter:url" content="http://epicpharmacyokc.com/services/">

  <meta name="robots" content="index, follow" />

  <link rel="canonical" href="http://epicpharmacyokc.com/services/">
  <link rel="alternate" href="http://epicpharmacyokc.com/services/" hreflang="en-us" />
...
<section class="page-builder-block hero" data-single-hero="true" data-alignment="left">
  <div class="container">
    <div class="cols hero__wrapper">
        ...
        <h1 data-break="lines">PATIENT SERVICES</h1>

        <p class="p1">Our team is dedicated to helping patients access medications and therapies needed so they can enjoy active, fulfilling lives.</p>
...
<!-- <section class="page-builder-block text-image-cols js-block" data-block="text-image-cols-block" data-reversed="true" data-sticky="false" data-spacing="medium">
  ...
  <div class="general-content">
        ...
        <p>HIV attacks the CD4 cells, a subtype of T-cells responsible for fighting infections in the body. This, in turn, takes away the bodyï¿½s capability to defend itself against infections.</p>

        <p>The symptoms of HIV vary from person to person. A person with HIV may show symptoms different from another person.
        </p>
               ...
               <div class="listing-blocks__wrapper">
                  <div class="cols">
                        ...
                        <div class="listing-blocks__fig-wrapper">
                           <div class="listing-blocks__fig-inner">
                              <figure class="listing-blocks__fig cover cover--all">
                                 <img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/services-paa.jpg' data-srcset='../assets/images/services-paa.jpg 750w, ../assets/images/services-paa.jpg 1200w, ' alt='Prior Authorization Assistance (PAA)' width='800' height='800'  data-pin-nopin='true' data-object-fit />              
                              </figure>
                           </div>
                        </div>
                     </div>
                     <div class="listing-blocks__inner col m12 tp8 t6 d4">
                        ...
                        <h3 class="listing-blocks__heading">Prior Authorization Assistance (PAA)</h3>
                        <div class="listing-blocks__content">
                           <p>At Epic Pharmacy, our commitment to helping each patient achieve the best possible outcomes is unwavering. This is why we provide a comprehensive offering that allows us to truly partner with each patient's personal care team - including physicians and insurance providers. As part of this, Epic Pharmacy proudly provides support with Prior Authorizations to ensure patients get access to the medications they need in a timely manner. This also takes the administrative burden off of physician practices so they can focus on what they do best - providing care and attention to their patients.
                           </p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="cols">
                     ...
                     <div class="listing-blocks__fig-container col m12 t6 d4">
                        <div class="listing-blocks__fig-wrapper">
                           <div class="listing-blocks__fig-inner">
                              <figure class="listing-blocks__fig cover cover--all">
                                 <img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/services-fa.jpg' data-srcset='../assets/images/services-fa.jpg 750w, ../assets/images/services-fa.jpg 1200w, ' alt='Financial Assistance' width='800' height='800'  data-pin-nopin='true' data-object-fit />            
                              </figure>
                           </div>
