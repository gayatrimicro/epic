...
<meta name="google-site-verification" content="A-llZMVa8hZh-UpSwLh1pVOmWUxxhd8MrBf7OTQjtEE" />
  ...
  <title>Specialty Franchisees | Epic Pharmacy</title>

  <meta name="description" content="Medicine Store Franchisee with Epic Pharmacy | Open your own internet pharmacy in the US" >

  <meta name="keywords" content="ready to become a pharmacy franchisee owner, pharmacy franchising, own your own community franchisee in oklahoma, pharmacy frachisee opportunities in the us">
...
<section class="page-builder-block text-image-cols js-block" data-block="text-image-cols-block" data-reversed="true" data-sticky="false" data-spacing="medium">
  <h1 style="text-align: center;margin-bottom: 70px;">Payors</h1>
  <div class="container">
            ...
            <div class="text-image-cols__image-wrapper">
              <div class="text-image-cols__image-inner">
                ...
                <div class="text-image-cols__image">
                  <figure class='text-image-cols__fig cover cover--all cover--crop-center'><img class='lazyload' data-sizes='auto' data-lowsrc='../assets/images/payors-1.jpg' data-srcset='../assets/images/payors-1.jpg 620w, ../assets/images/payors-1.jpg 1240w, ' alt='asthma-1' width='800' height='800'  data-pin-nopin='true' data-object-fit />                  </figure>
                </div>
  ...
  <div class="general-content">
        ...
        <p><strong>HOW WE BENEFIT OUR PAYOR PARTNERS</strong> </p>

        <p style="margin-top: 0px;">Epic Pharmacy is the specialty pharmacy that serves you, the Payor. Your goals and your Members matter to us. We seek to provide the right drug, right dose, at the right time and for the right patient.</p>


        <ol>
          <li>We customize and attune our service model to help you meet your financial and clinical objectives.</li>
          <li>We verify appropriateness of therapy, working with Prescribers and Patients according to your medical protocols to ensure that your desired outcomes are met.</li>
          <li>Epic supports and strengthens your relationships with physicians across our national network of Prescribers, while facilitating the adoption of your formulary policies.</li>
        </ol>
